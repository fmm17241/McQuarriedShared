...
Frank's streamling the creation of environments for modeling.

Instead of retyping every time, I'm adding them to a series of scripts.

Now I can call this code to create bellhop models of my chosen scenarios.

A work in progress. This will be the base of third research chapter's analysis.
"""
