...
A script for either:
    - Grabbing an SSP from a glider profile, or
    - Using a simple example (mixed, heterogeneous, etc.)

Creates the SSP necessary to model sound propagation in that environment.
