%2023, Frank McQuarrie
%This is creates a .env file, a variable necessary to model acoustic propagation.
% The challenges were that every SSP was a different length, and not all were strictly
% monotonic (all in one direction or plateuing, never turning). Gliders don't fly perfectly,
% so this does some pruning for us.
% Assumptions:
% Filename, "nbdAnalysis.env", line 27. This was the file used by collaborators.
% Bathymetry, assumed flat. This is for very quick estimates when an AUV surfaces, not using altimetry data.
% Frequency, held at 69 kHz for our active acoustic transmissions.
% C-linear interpolation for the soundspeed profile between points, spline fit gave too many erroneous values.
% 
% Frank is currently (Jan 2025) editing this method for more robust testing. 
